...
- **Description** : This project provides an analytical dashboard showcasing data about Netflix shows and movies, compiled from a dataset available on Kaggle. The dataset spans releases from 1925 to 2021, covering a wide range of titles across various genres and ratings.
- **[Netflix Report - PowerBI](https://github.com/Venkatasr665/Netflix-PowerBI-Report)**
